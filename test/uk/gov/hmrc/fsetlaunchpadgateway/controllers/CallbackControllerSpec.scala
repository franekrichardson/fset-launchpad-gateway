...
class CallbackControllerSpec extends BaseControllerSpec with OneAppPerSuite {
  "Callback Controller#present" should {
    ...
    "correctly parse and reply to one-reviewer Reviewed Callbacks" in new TestFixture {
      ...
      val callbackCaptor = ArgumentCaptor.forClass(classOf[ReviewedCallbackRequest])

      verify(mockFaststreamClient, times(1)).reviewedCallback(callbackCaptor.capture)(any[HeaderCarrier]())

      val capturedReviewersSection = callbackCaptor.getValue.reviews.reviewers
      capturedReviewersSection.reviewer2 mustBe None
      capturedReviewersSection.reviewer3 mustBe None
    }

    "correctly parse and reply to two-reviewer Reviewed Callbacks" in new TestFixture {
      ...
      val capturedReviewersSection = callbackCaptor.getValue.reviews.reviewers
      capturedReviewersSection.reviewer2 mustBe defined
      capturedReviewersSection.reviewer3 mustBe None
    }

    "correctly parse and reply to three-reviewer Reviewed Callbacks" in new TestFixture {
      val result = controller.present()(makeCallbackJsonPostRequest(threeReviewerCallbackJson))
      ...
      val capturedReviewersSection = callbackCaptor.getValue.reviews.reviewers
      capturedReviewersSection.reviewer2 mustBe defined
      capturedReviewersSection.reviewer3 mustBe defined
    }
  ...
  trait TestFixture {
    ...
    val twoReviewerCallbackJson =
      s"""
         ...
         |            },
         |            "reviewer_2": {
         |                "name": "AN Other Reviewer",
         |                "email": "a.n.other.reviewer@reviewer.com",
         |                "comment": null,
         |                "question_1": {
         |                    "text": "This is the other text for question 1?",
         |                    "id": 18,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description",
         |                        "type": "numeric",
         ...
         |                },
         |                "question_2": {
         |                    "text": "This is the Other text for question 2?",
         |                    "id": 21,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description   ",
         |                        "type": "numeric",
         ...
         |                },
         |                "question_3": {
         |                    "text": "This is the Other text for question 3?",
         |                    "id": 24,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description",
         |                        "type": "numeric",
         ...
         |                },
         |                "question_4": {
         |                    "text": "This is the Other text for question 4?",
         |                    "id": 27,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description        ",
         |                        "type": "numeric",
         ...
         |                },
         |                "question_5": {
         |                    "text": "This is the Other text for question 5?",
         |                    "id": 30,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description      ",
         |                        "type": "numeric",
         ...
         |                },
         |                "question_6": {
         |                    "text": "This is the Other text for question 6?",
         |                    "id": 33,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description   ",
         |                        "type": "numeric",
         ...
         |                },
         |                "question_7": {
         |                    "text": "This is the Other text for question 7?",
         |                    "id": 36,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description ",
         |                        "type": "numeric",
         ...
         |                },
         |                "question_8": {
         |                    "text": "This is the Other text for question 8?",
         |                    "id": 39,
         |                    "review_criteria_1": {
         |                        "text": "Other Criteria \\r\\n 1 and Criteria \\r\\n\\r\\n2 description  ",
         |                        "type": "numeric",
